...
<h2><?= $isEdit ? '✏️ Modifier la réservation' : '📅 Réserver une salle universitaire'; ?></h2>
...
<form method="POST" action="<?= $isEdit ? '/reservations/' . e($reservation->id) . '/edit' : '/reservations'; ?>" class="form">
    ...
    <div class="form-actions">
        <button type="submit" class="btn btn-success"><?= $isEdit ? 'Enregistrer les modifications' : 'Confirmer la réservation'; ?></button>
