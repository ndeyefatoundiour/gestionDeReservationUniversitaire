...
<div class="content-panel">
    <div class="toolbar">
        <h2><?= $isEdit ? '✎ Modifier la salle' : '✦ Ajouter une nouvelle salle'; ?></h2>
    ...
    <form method="POST" action="<?= $isEdit ? '/salles/' . e($salle->id) . '/edit' : '/salles'; ?>" class="form">
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-success"><span class="btn-icon">✓</span> Enregistrer la salle</button>
            <a href="/salles" class="btn"><span class="btn-icon">✕</span> Annuler</a>
        </div>
    </form>
</div>
